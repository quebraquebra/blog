...
data_filename <- "../../_data/senado_dados_2016_aposentados.csv"
data <- read.csv2(file=data_filename, sep=",", stringsAsFactors=F, header=T, dec=".", encoding = "UTF-8")
...
```{r assessores_2016}
senado_2016 <- data[data$ano==2016,]
data_filename <- "../../_data/qtde_assessores.csv"
qtde_assessores <- read.csv2(file=data_filename, sep=",", stringsAsFactors=F, header=T, dec=".", encoding = "UTF-8")
...
assessores_ja <- read.csv2(file="../../_data/assessores_joao_alberto.csv", sep=",", stringsAsFactors=F, header=T, dec=".", encoding = "UTF-8")
...
####################### Assessores João Alberto #######################
assessores_col <- read.csv2(file="../../_data/assessores_collor.csv", sep=",", stringsAsFactors=F, header=T, dec=".", encoding = "UTF-8")
...
assessores_he <- read.csv2(file="../../_data/assessores_helio_jose.csv", sep=",", stringsAsFactors=F, header=T, dec=".", encoding = "UTF-8")
...
Na tabela abaixo mostramos o custo em 2016 dos top-3 senadores em termos do número de assessores considerando somente comissionados, efetivos e escritório de apoio. O custo total somado desses três senadores em 2016 só em assessores foi de R$ `r round(custo_total/10^6, 1)` milhões. 
