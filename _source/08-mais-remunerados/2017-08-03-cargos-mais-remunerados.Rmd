...
mr_camara_cargo <- read_csv(file="../../_data/08-mais-remunerados/mr_camara_cargo.csv", sep=",", col_names = T)
mr_camara_nome <- read_csv(file="../../_data/08-mais-remunerados/mr_camara_nome.csv", col_names=T)
mr_camara_vinculo <- read_csv(file="../../_data/08-mais-remunerados/mr_camara_vinculo.csv", sep=",", col_names=T)
mr_senado_nome <- read_csv(file="../../_data/08-mais-remunerados/mr_senado_nome.csv", sep=",", col_names=T)
mr_senado_cargo <- read.csv2(file="../../_data/08-mais-remunerados/mr_senado_cargo.csv", col_names=T)
mr_senado_especialidade <- read.csv2(file="../../_data/08-mais-remunerados/mr_senado_especialidade.csv", col_names=T)
mr_senado_vinculo <- read_csv(file="../../_data/08-mais-remunerados/mr_senado_vinculo.csv", col_names=T)
qc_camara_cargo <- read_csv(file="../../_data/08-mais-remunerados/qc_camara_cargo.csv", sep=",", col_names=T)
qc_camara_vinculo <- read_csv(file="../../_data/08-mais-remunerados/qc_camara_vinculo.csv", col_names=T)
qc_senado_cargo <- read_csv(file="../../_data/08-mais-remunerados/qc_senado_cargo.csv", sep=",",col_names=T)
