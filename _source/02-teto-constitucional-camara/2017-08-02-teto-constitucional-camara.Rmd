...
* **No geral, quem são os servidores que mais ultrapassaram o teto?**
  ...
  Entretanto, existem servidores (deputados ou não) que receberam ainda mais vezes acima do teto constitucional. No gráfico seguinte, mostra-se os dez servidores que mais receberam acima do teto constitucional entre os anos `r ano_min` e `r ano_max`.
