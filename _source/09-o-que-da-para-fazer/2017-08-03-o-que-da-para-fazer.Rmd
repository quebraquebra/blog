...
```{r capes, echo=FALSE}
frink <- image_read("../../_data/imagens/capes.jpeg")
custo <- 2200
...
image <- image_annotate(frink, texto, size = 50, gravity = "center", strokecolor="black", color = "white", font='../../_data/fontes/Impact.ttf')
plot(image)
```

```{r samu, echo=FALSE}
frink <- image_read("../../_data/imagens/samu2.jpg")
custo <- 150000
...
frink <- image_read("../../_data/imagens/empregado-domestico2.jpg")
custo <- 120
...
frink <- image_read("../../_data/imagens/hospital2.jpg")
custo <- 8525928.52
...
frink <- image_read("../../_data/imagens/brasilia2.jpg")
...
image <- image_annotate(frink, texto, size = 30, gravity = "center", strokecolor="black", color = "white", location='+0+80', font='../../_data/fontes/Impact.ttf')
plot(image)
```
