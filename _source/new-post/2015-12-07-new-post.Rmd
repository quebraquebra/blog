...
```{r carregando_dados,echo=FALSE,include=FALSE}
...
```{r especialidades, echo=FALSE, message=FALSE}
...
```{r diferença, echo=FALSE, message=FALSE}
q = highchart() %>%
...
```{r aposentadorias, echo=FALSE, message=FALSE}
p = highchart() %>%
  hc_chart(type="column") %>%
