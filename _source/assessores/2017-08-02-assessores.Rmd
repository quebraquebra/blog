...
knitr::opts_chunk$set(screenshot.force = FALSE, echo = FALSE,message=FALSE, warning=FALSE, fig.cap = "")
library(highcharter)
library(readr)
library(dplyr)
library(reshape2)
...
```{r assessores_2016}
senado_2016 <- data[data$ano==2016,]
qtde_assessores <- readr::read_csv(file="qtde_assessores.csv")
...
assessores_ja <- readr::read_csv(file="assessores_joao_alberto.csv")
...
####################### Assessores João Alberto #######################
assessores_col <- readr::read_csv(file="assessores_collor.csv")
...
assessores_he <- readr::read_csv(file="assessores_helio_jose.csv")
